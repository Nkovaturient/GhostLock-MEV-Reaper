...
export const CONTRACTS = {
  GHOSTLOCK_INTENTS: process.env.VITE_GHOSTLOCK_INTENTS_ADDRESS as Address || '0x0000000000000000000000000000000000000000',
  BATCH_SETTLEMENT: process.env.VITE_BATCH_SETTLEMENT_ADDRESS as Address || '0x0000000000000000000000000000000000000000',
  EPOCH_RNG: process.env.VITE_EPOCH_RNG_ADDRESS as Address || '0x0000000000000000000000000000000000000000',
  MOCK_TOKEN_A: process.env.VITE_MOCK_TOKEN_A_ADDRESS as Address || '0x0000000000000000000000000000000000000000',
  MOCK_TOKEN_B: process.env.VITE_MOCK_TOKEN_B_ADDRESS as Address || '0x0000000000000000000000000000000000000000',
} as const
